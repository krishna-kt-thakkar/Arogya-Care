...
const AIAssistantPage: React.FC = () => {
  ...
  const getMessageIcon = (type: Message['type']) => {
    switch (type) {
      ...
      default: return <Bot className="h-4 w-4 text-secondary-custom" />;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-secondary-custom mt-1">Your personal medical AI companion</p>
            </div>
          </div>
        ...
        {/* Chat Interface */}
        <motion.div
          className="bg-card-surface rounded-3xl shadow-lg border border-card-custom h-[600px] flex flex-col"
          ...
          <div className="p-6 border-b border-card-custom">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-primary-custom">Dr. AI Assistant</h3>
                  <p className="text-sm text-secondary-custom">Medical AI • Always Available</p>
                </div>
              </div>
                ...
                <div className={`max-w-xs lg:max-w-md ${message.isUser ? 'order-2' : 'order-1'}`}>
                  {!message.isUser && (
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-xs font-medium text-secondary-custom uppercase tracking-wide">
                  ...
                  <div className={`px-4 py-3 rounded-2xl ${
                    message.isUser
                      ...
                      ? 'bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 text-primary-custom border border-green-200 dark:border-green-700'
                      : message.type === 'reminder'
                      ? 'bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 text-primary-custom border border-blue-200 dark:border-blue-700'
                      : message.type === 'analysis'
                      ? 'bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 text-primary-custom border border-purple-200 dark:border-purple-700'
                      : 'bg-white/5 text-primary-custom'
                  }`}>
                    <p className="text-sm leading-relaxed whitespace-pre-line">{message.text}</p>
                    <p className={`text-xs mt-2 ${
                      message.isUser ? 'text-blue-100' : 'text-secondary-custom'
                    }`}>
        ...
        >
          {[
            ...
            <motion.button
              ...
              className="p-4 bg-card-surface rounded-2xl border border-card-custom hover:border-blue-300 dark:hover:border-blue-600 transition-all text-center group"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
